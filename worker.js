...
export default{async fetch(req){if(req.method==="OPTIONS")return new Response("{}",{headers});return new Response(JSON.stringify({ok:true,message:"フロント側ロジックで全自動予想します。"}),{headers})}};
